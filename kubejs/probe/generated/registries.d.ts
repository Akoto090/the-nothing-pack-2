...
declare namespace Registry {
    ...
    class Block extends Internal.RegistryEventJS<any> {
        ...
        create(id: string, type: "gtceu:coil"): Internal.CoilBlockBuilder;
        create(id: string, type: "gtceu:renderer"): Internal.RendererBlockBuilder;
        create(id: string, type: "gtceu:renderer_glass"): Internal.RendererGlassBlockBuilder;
    ...
    class LizardFrillVariant extends Internal.RegistryEventJS<any> {
    }
    class LizardHornVariant extends Internal.RegistryEventJS<any> {
    }
    class GlassArrowVariant extends Internal.RegistryEventJS<any> {
    }
    class InkColor extends Internal.RegistryEventJS<any> {
    }
    class SoundEffects extends Internal.RegistryEventJS<any> {
    }
    class ExplosionEffectFamily extends Internal.RegistryEventJS<any> {
    }
    class ExplosionEffectModifier extends Internal.RegistryEventJS<any> {
    }
    class ReverbEffect extends Internal.RegistryEventJS<any> {
    }
    class DistortionEffect extends Internal.RegistryEventJS<any> {
    }
    ...
    class CamoContainers extends Internal.RegistryEventJS<any> {
    }
    ...
    class Ritual-effects extends Internal.RegistryEventJS<any> {
    }
    class Shapes extends Internal.RegistryEventJS<any> {
    }
    class TrackType extends Internal.RegistryEventJS<any> {
    }
    class GridType extends Internal.RegistryEventJS<any> {
    }
    class AInstrument extends Internal.RegistryEventJS<any> {
    }
    class BWoodType extends Internal.RegistryEventJS<any> {
    }
    class CTotemCarving extends Internal.RegistryEventJS<any> {
    }
    class DCeremony extends Internal.RegistryEventJS<any> {
    }
