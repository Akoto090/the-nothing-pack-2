...
declare const GTCEuServerEvents: {
    /**
     * @at *server*
    */
oreVeins(handler: (event: Internal.GTOreVeinEventJS) => void):void,
    /**
     * @at *server*
    */
fluidVeins(handler: (event: Internal.GTFluidVeinEventJS) => void):void,
    /**
     * @at *server*
    */
bedrockOreVeins(handler: (event: Internal.GTBedrockOreVeinEventJS) => void):void,
};
...
declare const GTCEuStartupEvents: {
    /**
     * @at *startup*
    */
registry(extra: string, handler: (event: Internal.GTRegistryEventJS<any, any>) => void):void,
    /**
     * @at *startup*
    */
materialModification(handler: (event: Internal.MaterialModificationEventJS) => void):void,
};
...
registry(type: "spectrum:lizard_frill_variant", handler: (event: Registry.LizardFrillVariant) => void):void,
registry(type: "spectrum:lizard_horn_variant", handler: (event: Registry.LizardHornVariant) => void):void,
registry(type: "spectrum:glass_arrow_variant", handler: (event: Registry.GlassArrowVariant) => void):void,
registry(type: "spectrum:ink_color", handler: (event: Registry.InkColor) => void):void,
registry(type: "reverb:sound_effects", handler: (event: Registry.SoundEffects) => void):void,
registry(type: "spectrum:explosion_effect_family", handler: (event: Registry.ExplosionEffectFamily) => void):void,
registry(type: "spectrum:explosion_effect_modifier", handler: (event: Registry.ExplosionEffectModifier) => void):void,
registry(type: "reverb:reverb_effect", handler: (event: Registry.ReverbEffect) => void):void,
registry(type: "reverb:distortion_effect", handler: (event: Registry.DistortionEffect) => void):void,
...
registry(type: "framedblocks:camo_containers", handler: (event: Registry.CamoContainers) => void):void,
...
registry(type: "mna:components", handler: (event: Registry.Components) => void):void,
registry(type: "mna:construct_task", handler: (event: Registry.ConstructTask) => void):void,
registry(type: "mna:factions", handler: (event: Registry.Factions) => void):void,
registry(type: "mna:modifiers", handler: (event: Registry.Modifiers) => void):void,
registry(type: "mna:ritual-effects", handler: (event: Registry.Ritual-effects) => void):void,
registry(type: "mna:shapes", handler: (event: Registry.Shapes) => void):void,
registry(type: "railcraft:track_type", handler: (event: Registry.TrackType) => void):void,
registry(type: "thermal_dynamics:grid_type", handler: (event: Registry.GridType) => void):void,
registry(type: "totemic:a_instrument", handler: (event: Registry.AInstrument) => void):void,
registry(type: "totemic:b_wood_type", handler: (event: Registry.BWoodType) => void):void,
registry(type: "totemic:c_totem_carving", handler: (event: Registry.CTotemCarving) => void):void,
registry(type: "totemic:d_ceremony", handler: (event: Registry.DCeremony) => void):void,
